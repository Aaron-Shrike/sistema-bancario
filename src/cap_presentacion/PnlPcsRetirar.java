 ...
 * @author Sh
 */
public class PnlPcsRetirar extends javax.swing.JPanel {
    
    private boolean encontrado = false;
    private boolean activa = true;

    /**
     * Creates new form PnlPcsRetirar
     */
    public PnlPcsRetirar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txTitulo.setText("■ Retirar de una cuenta bancaria");
        ...
        txMonto.setText("Monto a retirar:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        tfMontoRetiro.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        tfMontoRetiro.setForeground(new java.awt.Color(153, 153, 153));
        tfMontoRetiro.setText(Strings.ejmMonto);
        tfMontoRetiro.setCaretPosition(0);
        tfMontoRetiro.setPreferredSize(new java.awt.Dimension(450, 35));
        tfMontoRetiro.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tfMontoRetiroMousePressed(evt);
            }
        });
        tfMontoRetiro.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfMontoRetiroKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tfMontoRetiroKeyReleased(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(27, 20, 0, 0);
        add(tfMontoRetiro, gridBagConstraints);
    ...
    private void btLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLimpiarActionPerformed
        ...
        tfMontoRetiro.setText(Strings.ejmMonto);
        tfMontoRetiro.setCaretPosition(0);
        tfMontoRetiro.setForeground(new Color(153,153,153));
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        try {
            ...
            if(encontrado && activa){
                ...
                double retiro = Double.parseDouble(tfMontoRetiro.getText());
                Cuenta objCue = new Cuenta();
                
                boolean acepto = objCue.retirarMonto(cuenta, retiro);
    ...
    */
    ...
    private void tfMontoRetiroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfMontoRetiroMousePressed
        // TODO add your handling code here:
        if(tfMontoRetiro.getText().equals(Strings.ejmMonto)){

            tfMontoRetiro.setCaretPosition(0);
        }
    }//GEN-LAST:event_tfMontoRetiroMousePressed

    private void tfMontoRetiroKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfMontoRetiroKeyPressed
        // TODO add your handling code here:
        if(tfMontoRetiro.getText().equals(Strings.ejmMonto)){

            tfMontoRetiro.setForeground(new Color(0,0,0));
            tfMontoRetiro.setText("");
        }
    }//GEN-LAST:event_tfMontoRetiroKeyPressed

    private void tfMontoRetiroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfMontoRetiroKeyReleased
        // TODO add your handling code here:
        boolean letra = false;
        
        if(tfMontoRetiro.getCaretPosition() == 0 && tfMontoRetiro.getText().equals("")){
            ...
            for (int i = 0; i < tfMontoRetiro.getText().length(); i++) {
                char c = tfMontoRetiro.getText().charAt(i);
            ...
            if(letra == true){
                tfMontoRetiro.setForeground(new Color(255,51,51)); // rojo
            }else{
                tfMontoRetiro.setForeground(new Color(0,0,0)); // negro
            }
        }
    }//GEN-LAST:event_tfMontoRetiroKeyReleased
